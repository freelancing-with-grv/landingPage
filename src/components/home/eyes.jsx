  ...
  return (
    <>
      <div className="eye w-full h-screen overflow-hidden">
        <div data-scroll data-scroll-speed="-.2" className="w-full relative h-full bg-cover bg-center bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-1440x921.jpg')]">
