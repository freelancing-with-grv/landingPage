    ...
    <div className="w-full flex gap-5 h-screen bg-zinc-900 p-20">
      <div className="w-1/2 flex flex-col justify-between h-full items-start">
        <div className="heading">
          <h1 className="text-[8vw] uppercase leading-[7vw] font-semibold tracking-tighter">
            EYE-
          </h1>
          <h1 className="text-[8vw] uppercase leading-[7vw] font-semibold tracking-tighter">
            OPENING
      ...
      <div className="w-1/2">
        <h1 className="text-[6vw] uppercase leading-[7vw] font-semibold tracking-tighter">
          Presentations
        </h1>
        <div className="dets mt-10">
          <span className="text-xl">S:</span>
          {["Facebook", "twitter", "instagram", "gmail"].map((item, index) => (
            <a className="block uppercase font-light text-xl" key={index} href="">
              {item}
            </a>
          ))}
        </div>
